    ...
    >
      ...
      >
        ...
        <Grid item xs={12} md={8}>
          ...
          {studyPlans.length > 0 && <h3 style={{ marginBottom: "20px"}}>Your current study plans:</h3>}
            ...
            {studyPlans.map((plan) => (
              <Grid item xs={12} sm={6} md={4} key={plan.id}>
                ...
                >
                  ...
                  <CardActions style={{ marginBottom: "10px", marginLeft: "5px"}}>
                    <Button size="small" variant="contained" sx={{ marginRight: "5px" }}>View</Button>
                    <Button size="small" variant="outlined" sx={{ marginRight: "5px" }}>Mark as Complete</Button>
                    <Button
                      size="small"
                      color="error"
